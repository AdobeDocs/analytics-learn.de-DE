...
Das schreibgeschützte Projekt ist auch für die Freigabe von Daten mit Benutzenden hilfreich, die über wenig Adobe Analytics-Erfahrung verfügen, z. B. Marketing-Kollegen, die Produkteinführungskampagnen steuern und ihnen ein Kampagnen-Dashboard mit vordefinierten Aufschlüsselungen der Konversions- und Marketing-Kanäle bereitstellen.

## Eine andere Möglichkeit - die mobile Scorecard

Neben der schreibgeschützten Projektfreigabe bietet Analytics Dashboard einen weiteren Ansatz zur Freigabe von für Führungskräfte geeigneten Dashboards mit vordefinierter Erfahrung. Beim Erstellen eines neuen Projekts in Analysis Workspace handelt es sich um die „mobile Scorecard“. Das daraus resultierende Projekt ist dann in der mobilen App &quot;Adobe Analytics&quot; verfügbar. Auf diese Weise können wir KPIs für digitale Erlebnisse mit Führungskräften in einer einfachen und benutzerfreundlichen Mobile App teilen, auf die überall und jederzeit zugegriffen werden kann.

Ein gutes Dashboard für Führungskräfte sollte einfach und in wichtigen Punkten verfügbar sein. Durch Hinzufügen nur von KPIs zum ersten Bildschirm eines Analytics-Dashboards mit einer optionalen Aufschlüsselung auf einer Ebene, um einen KPI anhand einer Dimension aus einem vordefinierten Satz von Auswahlmöglichkeiten aufzuschlüsseln. Mit dem Analytics-Dashboard können wir eine Geschichte erzählen, die wir an Führungskräfte richten möchten.

Selbst wenn Ihre Vorgesetzten das Analytics-Dashboard nicht direkt verwenden, sollten Sie diese KPIs im Analytics-Dashboard parat haben und die Antwort auf Ihre Fragen sofort erhalten, Sie sehen einfach cool und gut vorbereitet aus.
Wenn wir Adobe Analytics innerhalb eines Unternehmens anwenden, möchten wir wahrscheinlich allen Benutzenden mit allen Funktionen ermöglichen, Workspace-Projekte für Analysen zu erstellen/zu ändern. Es gibt jedoch Benutzende mit unterschiedlichen Fähigkeiten und Schwerpunkten. Einige von ihnen müssen nur Daten in einigen vordefinierten Arbeitsbereich-Projekten nutzen und werden keine weitere Analyse durchführen, da sie nur über geringe Erfahrung mit Adobe Analytics verfügen. Das schreibgeschützte Projekt- oder Analytics-Dashboard bietet eine einfache Oberfläche mit vordefinierten Erlebnissen für den Datenzugriff.
