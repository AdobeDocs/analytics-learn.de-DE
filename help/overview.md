...
Holen Sie das Meiste aus [!DNL Adobe Analytics].  Verwenden Sie diese Tutorials, um die Funktionen von Analytics zu verstehen und die Vorteile für Ihr Unternehmen optimal zu nutzen. Diese Inhalte sind für Administratoren, Datenanalysten, Marketing-Experten, Entwickler und Architekten geeignet.
...
* **[Adobe Analytics Mobile Scorecard Builder (Video)](additional-tools/analytics-dashboards/adobe-analytics-dashboards-scorecard-builder.md)**
   *Erfahren Sie, wie Sie in [!DNL Analysis Workspace] generierte mobile Scorecards erstellen und für Führungskräfte freigeben.*
